...
When **reviewing recordings** in Mingtily, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Mingtily records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Mingtily recordings** - Use wired/speakers instead
...
### This is Not a Mingtily Bug

The issue is in **macOS's Bluetooth audio stack**, not in Mingtily's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Mingtily bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Mingtily now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Mingtily v0.0.5+ on macOS
