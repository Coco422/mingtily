...
**Mingtily** is a local-first AI meeting assistant that captures, transcribes, and summarizes meetings with a Rust/Tauri desktop core.
...
- **Production (macOS)**: `~/Library/Application Support/Mingtily/models/`
- **Production (Windows)**: `%APPDATA%\Mingtily\models\`
