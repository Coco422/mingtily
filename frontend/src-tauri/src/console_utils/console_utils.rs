...
pub fn show_console() -> Result<String, String> {
    ...
    unsafe {
        ...
        if console_window == ptr::null_mut() {
            ...
            log::info!("Allocated a Windows diagnostics console");
        } else {
        ...
        match Command::new("osascript")
            ...
            .arg(
                ...
                tell application "Terminal"
                    activate
                    do script "log stream --process mingtily --level info --style compact"
                end tell
            "#,
            )
            .spawn()
            ...
            .arg(r#"
                tell application "Terminal"
                    ...
                    repeat with aWindow in windowList
                        if contents of selected tab of aWindow contains "log stream --process mingtily" then
                            close aWindow
                        end if
                    end repeat
                end tell
