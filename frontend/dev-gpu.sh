#!/bin/bash
# GPU-accelerated development script for Mingtily
...
echo -e "${BLUE}🚀 Mingtily GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting Mingtily in development mode...${NC}"
echo ""
