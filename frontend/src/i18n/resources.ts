...
export const resources = {
  'en-US': {
    ...
    recording: {
      ...
      openMicrophone: 'Microphone Settings', openScreenRecording: 'System Audio Settings',
      ...
      installVirtualDevice: 'Open Privacy & Security → Screen & System Audio Recording',
      grantScreenPermission: 'Enable Mingtily under System Audio Recording Only', configureAudio: 'Return to Mingtily and try recording again',
    ...
    onboarding: {
      ...
      systemAudioDescription: 'Enable Mingtily under System Audio Recording Only, then choose Open Settings again to verify', finish: 'Finish setup', later: 'I’ll do this later',
      permissionHint: 'Microphone recording requires access. Without system-audio access, recording continues with the microphone only.',
      accessGranted: 'Access granted', accessDenied: 'Not verified — allow access in System Settings, then try again',
    },
    errors: {
  ...
  'zh-CN': {
    ...
    recording: {
      ...
      start: '开始录音', stop: '停止录音', pause: '暂停录音', resume: '继续录音', pausing: '正在暂停…', resuming: '正在继续…', stopping: '正在停止…', recording: '录音中', paused: '已暂停', duration: '录音时长', processing: '正在处理录音…', validating: '正在检查语音识别…', finalizing: '正在完成转写…', saving: '正在保存转写…', copyTranscript: '复制转写', transcriptLanguage: '转写语言', permissionsRequired: '需要权限', microphoneRequired: '需要麦克风权限', systemAudioRequired: '需要系统音频权限', openMicrophone: '麦克风设置', openScreenRecording: '系统音频设置', micUnavailable: 'Mingtily 需要麦克风权限来录制会议，但未检测到可用麦克风。', check: '请检查：', micConnected: '麦克风已连接并开启', micPermission: '已在系统设置中授予麦克风权限', micNotBusy: '没有其他应用正在独占麦克风', systemUnavailable: '暂时无法采集系统音频。仍可录制麦克风，但无法录制电脑声音。', systemAlsoUnavailable: '暂时也无法采集系统音频。', systemSetup: '在 macOS 上启用系统音频：', installVirtualDevice: '打开“隐私与安全性 › 屏幕与系统音频录制”', grantScreenPermission: '在“仅系统音频录制”中启用 Mingtily', configureAudio: '返回 Mingtily 后重新开始录音', betaDisabled: 'Beta 功能已关闭', enableImport: '请在“设置 › Beta”中启用“导入音频并重新转写”。', dropAudio: '拖入音频文件', supportedFormats: '支持的格式：{{formats}}',
    ...
    onboarding: {
      ...
      welcome: '欢迎使用 Mingtily', tagline: '录音、转写、总结，都在你的设备上完成。', private: '数据始终留在你的设备上', insights: '清晰总结，提炼关键信息', offline: '可离线使用，无需云端', getStarted: '开始使用', takesMinutes: '不到 3 分钟', permissions: '授予权限', permissionsDescription: 'Mingtily 需要麦克风权限；开启系统音频权限后还能录制电脑声音。', microphone: '麦克风', microphoneDescription: '用于采集会议中的人声', systemAudio: '系统音频', systemAudioDescription: '在“仅系统音频录制”中启用 Mingtily，然后再次点击“打开设置”验证', finish: '完成设置', later: '稍后再说', permissionHint: '麦克风录音必须授权；未开启系统音频权限时，将仅录制麦克风。', accessGranted: '已授权', accessDenied: '尚未验证，请在系统设置中授权后重试',
    },
