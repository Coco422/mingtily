...
export const modelsResources = {
  'en-US': {
    ...
    sections: { transcription: 'Speech recognition models', transcriptionDescription: 'Download or remove local Whisper and Parakeet models. Choose the active model in Services.', speaker: 'Speaker diarization model', speakerDescription: 'Manage the local segmentation and speaker-embedding package.', localSummary: 'Built-in summary models', localSummaryDescription: 'Manage offline GGUF models used by Built-in AI.', ollama: 'Ollama models', ollamaDescription: 'Scan, pull, and remove models from the configured Ollama service.', advanced: 'Advanced models' },
    actions: { download: 'Download', retry: 'Retry', repair: 'Repair', delete: 'Delete', redownload: 'Download again', cancel: 'Cancel', cancelDownload: 'Cancel download', refresh: 'Refresh' },
    ...
    errors: { loadModels: 'Could not load models', loadTranscriptionModels: 'Could not load speech recognition models', unknown: 'Unknown error', corruptedModel: 'The file is corrupted. Retry the download or delete it.', generic: 'Something went wrong.' },
  ...
  'zh-CN': {
    ...
    sections: { transcription: '语音转写模型', transcriptionDescription: '下载或删除本地 Whisper、Parakeet 模型；当前使用的模型请在“服务”中选择。', speaker: '说话人分离模型', speakerDescription: '管理本地分割与说话人向量模型包。', localSummary: '内置总结模型', localSummaryDescription: '管理内置 AI 使用的离线 GGUF 模型。', ollama: 'Ollama 模型', ollamaDescription: '扫描、拉取或删除当前 Ollama 服务中的模型。', advanced: '高级模型' },
    actions: { download: '下载', retry: '重试', repair: '修复', delete: '删除', redownload: '重新下载', cancel: '取消', cancelDownload: '取消下载', refresh: '刷新' },
    ...
    errors: { loadModels: '模型加载失败', loadTranscriptionModels: '语音转写模型加载失败', unknown: '未知错误', corruptedModel: '模型文件已损坏，请重新下载或删除。', generic: '发生错误。' },
