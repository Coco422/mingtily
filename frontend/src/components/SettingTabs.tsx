...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">{t('legacyTabs.transcription')}</TabsTrigger>
    <TabsTrigger value="modelSettings">{t('legacyTabs.summary')}</TabsTrigger>
    <TabsTrigger value="recordingSettings">{t('legacyTabs.preferences')}</TabsTrigger>
    <TabsTrigger value="about">{t('legacyTabs.about')}</TabsTrigger>
  </TabsList>
