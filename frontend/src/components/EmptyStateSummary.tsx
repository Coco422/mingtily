  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-2">
        {t('meeting:summaryEmptyTitle')}
      </h3>
      <p className="text-sm text-gray-500 mb-6 max-w-md">
        {t('meeting:summaryEmptyDescription')}
      </p>
          ...
          <TooltipTrigger asChild>
            <div>
              ...
              >
                ...
                {isGenerating ? t('meeting:generatingSummary') : t('meeting:generateSummary')}
              </Button>
            </div>
          </TooltipTrigger>
          {!hasModel && (
            <TooltipContent>
              <p>{t('meeting:selectSummaryModel')}</p>
            </TooltipContent>
          )}
        </Tooltip>
      </TooltipProvider>
