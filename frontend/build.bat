@echo off
REM Mingtily Build Script for Windows
...
echo 🚀 Building Mingtily application...
...
echo.
echo ========================================
echo    Mingtily Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the Mingtily Tauri application for Windows.
